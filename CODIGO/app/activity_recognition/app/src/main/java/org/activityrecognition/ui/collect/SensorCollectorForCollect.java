...
public class SensorCollectorForCollect implements SensorEventListener {
    ...
    private PacketListenerForCollect listener;
    private List<String> packet;
    private MeasureGroup measureGroup;
    private long lastReportTime;

    public SensorCollectorForCollect(SensorManager sensorManager) {
    ...
    public void registerListener(PacketListenerForCollect listener) {
